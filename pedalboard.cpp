...
int main(int argc, char **argv) {
  ...
  // including duplicates of a kind -- so FX can't be singletons. The registry
  // (fx_registry.cpp, shared with the test suite) registers every kind with the
  // factory; the picker mints fresh instances on demand.
  registerAllFx(g_fx);
